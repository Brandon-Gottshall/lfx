...
class Lfx < Formula
  ...
  homepage "https://github.com/brandon-gottshall/ifx"
  version "{{VERSION}}"

  on_macos do
    on_arm do
      url "https://github.com/brandon-gottshall/ifx/releases/download/v#{version}/lfx-darwin-arm64.tar.gz"
      sha256 "{{DARWIN_ARM64_SHA256}}"
    end
    on_intel do
      url "https://github.com/brandon-gottshall/ifx/releases/download/v#{version}/lfx-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/brandon-gottshall/ifx/releases/download/v#{version}/lfx-linux-arm64.tar.gz"
      sha256 "{{LINUX_ARM64_SHA256}}"
    end
    on_intel do
      url "https://github.com/brandon-gottshall/ifx/releases/download/v#{version}/lfx-linux-amd64.tar.gz"
...
- On release tag in the main repo:
  ...
  - Open a PR against `homebrew-ifx` with the updated `Formula/lfx.rb`.
